...
import cn.mall.service.ProductService;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.data.domain.Page;
import org.springframework.data.domain.Pageable;
import org.springframework.stereotype.Service;
import cn.mall.dao.ClassificationDao;
import cn.mall.dao.ProductDao;
import cn.mall.entity.Classification;
...
//        calendar.add(Calendar.DAY_OF_MONTH, -14);
    ...
    @Override
    public List<Product> findByTitle(String title, Pageable pageable) {
        return productDao.findByTitleLike("%" + title + "%", pageable);
    }
}
